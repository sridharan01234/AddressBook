...
<body>
  ...
  <div class="flex-row items-center justify-between p-4 space-y-5 sm:flex sm:space-y-0 sm:space-x-4">
    ...
    <button type="button"
      ...
      <svg class="w-3.5 h-3.5 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
        id="UserPlus">
        <rect width="256" height="256" fill="none"></rect>
        <circle cx="128" cy="96" r="64" opacity=".2" fill="#d85b53" class="color000000 svgShape"></circle>
        <line x1="176" x2="224" y1="56" y2="56" fill="none" stroke="#26d7fe" stroke-linecap="round"
          stroke-linejoin="round" stroke-width="16" class="colorStroke000000 svgStroke"></line>
        <line x1="200" x2="200" y1="32" y2="80" fill="none" stroke="#26d7fe" stroke-linecap="round"
          stroke-linejoin="round" stroke-width="16" class="colorStroke000000 svgStroke"></line>
        <path fill="none" stroke="#26d7fe" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"
    ...
    <button type="button"
      class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
      <svg class="w-3.5 h-3.5 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Delete">
        <path
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      ...
      <tbody>
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
          <td class="w-4 p-4">
            <div class="flex items-center">
              <input name="delete_users[]" value="<?php echo $user->id ?>" id="flexCheckChecked<?php echo $user->id ?>"
