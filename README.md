...
INSERT INTO `users` (`id`, `name`, `first_name`, `last_name`, `email`, `password`) VALUES
(1, 'SriDharan', 'Sri', 'Dharan', 'sridharan01234@gmail.com', '$2y$10$DNnL8ne4sFozY.6iO5rPdunGbucqx0t1sxt7opZk7LO4vwB7zHTkO'),
(2, '', '', '', '', '$2y$10$H92fwb3Bf6py7eeZYb1VleVXox00TmYfGx6TYCwHJySzNkHDYLzqS');
...
ALTER TABLE `contacts`
  ...
  ADD CONSTRAINT `contacts_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  ADD CONSTRAINT `contacts_ibfk_3` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`);
