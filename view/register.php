...
<body>
  <section class="bg-gray-50 dark:bg-gray-900">
    ...
    echo " block"; } else { echo "none" ; } ?>;" class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50
              dark:bg-gray-800 dark:text-green-400" role="alert">
              <span class="font-medium">Success !</span>
              <?php echo $message ?>
            </div>
            <div style="display:<?php if (isset($error)) {
    echo " block"; } else { echo "none" ; } ?>;" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50
