      ...
      <div
        ...
        <div
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action id="register-form"
              method="post">
              <div style="display:<?php if (isset($message)) {echo " block"; }
                else { echo "none" ; } ?>;" class="p-4 mb-4
                text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800
                dark:text-green-400" role="alert">
                <span class="font-medium">Success !</span>
                <?php echo $message ?>
              </div>
              <div style="display:<?php if (isset($error)) { echo " block"; }
                else { echo "none" ; } ?>;" class="p-4 mb-4
